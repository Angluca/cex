...
__attribute__ ((visibility("hidden"))) extern const struct __cex_namespace__str str; // CEX Autogen
...
) extern const struct __cex_namespace__argparse argparse; // CEX Autogen
...
__attribute__ ((visibility("hidden"))) extern const struct __cex_namespace__CexParser CexParser; // CEX Autogen
__attribute__ ((visibility("hidden"))) extern const struct __cex_namespace__CexParser CexParser; // CEX Autogen
__attribute__ ((visibility("hidden"))) extern const struct __cex_namespace__CexParser CexParser; // CEX Autogen
