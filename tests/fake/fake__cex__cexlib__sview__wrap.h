...
FAKE_VALUE_FUNC(isize, __wrap_str__index, str_c*, const char*, u8)isize __real_str__index(str_c*, const char*, u8);
...
FAKE_VALUE_FUNC(isize, __wrap_str_indexof, str_c, str_c, usize, usize)isize __real_str_indexof(str_c, str_c, usize, usize);
