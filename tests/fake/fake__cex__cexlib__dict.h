...
FAKE_VALUE_FUNC(Exc, dict_create, dict_c*, usize, usize, usize, usize, dict_hash_func_f, dict_compare_func_f, const Allocator_i*, dict_elfree_func_f, void*)
...
FAKE_VALUE_FUNC(usize, dict_len, dict_c*)
...
FAKE_VALUE_FUNC(Exc, dict_tolist, dict_c*, void*, const Allocator_i*)
