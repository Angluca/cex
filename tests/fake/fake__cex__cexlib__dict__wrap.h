...
FAKE_VALUE_FUNC(Exc, __wrap_dict_create, dict_c*, usize, usize, usize, usize, dict_hash_func_f, dict_compare_func_f, IAllocator, dict_elfree_func_f, void*)Exception __real_dict_create(dict_c*, usize, usize, usize, usize, dict_hash_func_f, dict_compare_func_f, IAllocator, dict_elfree_func_f, void*);
...
FAKE_VALUE_FUNC(Exc, __wrap_dict_tolist, dict_c*, void*, IAllocator)Exception __real_dict_tolist(dict_c*, void*, IAllocator);
