...
FAKE_VALUE_FUNC(Exc, __wrap_deque_create, deque_c*, usize, bool, usize, usize, IAllocator)Exception __real_deque_create(deque_c*, usize, bool, usize, usize, IAllocator);
